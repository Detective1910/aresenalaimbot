...
CreditsSection:AddLabel("Made by: Space X Development")
...
client:console("Space X loaded in Follow @relayed for more" .. tostring(tick() - start) .. "ms")
